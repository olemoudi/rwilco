    ...
    fun `settings encode every field so a reader can rely on presence`() {
        ...
        assertEquals(
            """{"theme":"SYSTEM","defaultTime":"09:00","haptics":true,"defaultTriggerKind":null,""" +
                ...
                """"snoozeCustomMinutes":30,"notificationSnoozes":["TEN_MINUTES","TWO_HOURS"],"hiddenSnoozes":[],"snoozeUses":{},"customSnoozes":[],"dismissedAlertProblems":[],"compactHome":false,"compactRoutines":false,"disclaimerRead":false,"achievements":[]}""",
            encoded,
        )
    }
