    ...
    fun `settings encode every field so a reader can rely on presence`() {
        ...
        assertEquals(
            """{"theme":"SYSTEM","defaultTime":"09:00","haptics":true,"defaultTriggerKind":null,""" +
                ...
                """"defaultActions":["NOTIFICATION","VIBRATE"],"routineActions":["NOTIFICATION","VIBRATE"],"presets":[],"hiddenTexts":[],"tagPrefs":[],""" +
                ...
                """"snoozeCustomMinutes":30,"notificationSnoozes":["TEN_MINUTES","TWO_HOURS"],"dismissedAlertProblems":[],"compactHome":false,"compactRoutines":false,"disclaimerRead":false}""",
            encoded,
        )
    }
